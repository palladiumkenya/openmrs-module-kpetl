...
SELECT "Successfully created etl_pregnancy_fp_cacx_screening table";
 ...
 -- ------------ create table etl_tb_screening-----------------------
  CREATE TABLE kp_etl.etl_tb_screening (
    ...
    encounter_provider INT(11),
    date_created DATE,
    symptoms_present VARCHAR(100),
    test_ordered VARCHAR(100),
    sputum_smear_action VARCHAR(100),
    chest_xray_action VARCHAR(100),
    gene_xpert_action VARCHAR(100),
    clinical_diagnosis VARCHAR(100),
    invite_contacts VARCHAR(10),
    ipt_evaluated VARCHAR(10),
    tb_results_status VARCHAR(100),
    start_anti_TB VARCHAR(10),
    tb_treatment_date DATETIME,
