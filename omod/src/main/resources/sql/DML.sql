                     ...
                     CREATE PROCEDURE sp_populate_etl_peer_calendar()
                       BEGIN
                         ...
                         select
                               ...
                               max(if(o.concept_id=165058,o.value_numeric, null)) as week_1_monthly_n_and_s_distributed,
                               max(if(o.concept_id=165055,o.value_numeric,null)) as week_1_monthly_male_condoms_distributed,
                               max(if(o.concept_id=165057, o.value_numeric,null)) as week_1_monthly_lubes_distributed,
                               max(if(o.concept_id=165056, o.value_numeric,null)) as week_1_monthly_female_condoms_distributed,
                               max(if(o.concept_id=165222, o.value_numeric,null)) as week_1_monthly_self_test_kits_distributed,
                               max(if(o.concept_id=1774, o.value_coded,null)) as week_1_received_clinical_service,
                               max(if(o.concept_id=1774, o.value_coded,null)) as week_1_violence_reported,
                               max(if(o.concept_id=1272, o.value_coded,null)) as week_1_referred,
                               max(if(o.concept_id=165147, o.value_coded,null)) as week_1_health_edu,

                                max(if(o.concept_id=165058,o.value_numeric, null)) as week_2_monthly_n_and_s_distributed,
                              max(if(o.concept_id=165055,o.value_numeric,null)) as week_2_monthly_male_condoms_distributed,
                              max(if(o.concept_id=165057, o.value_numeric,null)) as week_2_monthly_lubes_distributed,
                              max(if(o.concept_id=165056, o.value_numeric,null)) as week_2_monthly_female_condoms_distributed,
                              max(if(o.concept_id=165222, o.value_numeric,null)) as week_2_monthly_self_test_kits_distributed,
                              max(if(o.concept_id=1774, o.value_coded,null)) as week_2_received_clinical_service,
                              max(if(o.concept_id=1774, o.value_coded,null)) as week_2_violence_reported,
                              max(if(o.concept_id=1272, o.value_coded,null)) as week_2_referred,
                              max(if(o.concept_id=165147, o.value_coded,null)) as week_2_health_edu,

                               max(if(o.concept_id=165058,o.value_numeric, null)) as week_3_monthly_n_and_s_distributed,
                             max(if(o.concept_id=165055,o.value_numeric,null)) as week_3_monthly_male_condoms_distributed,
                             max(if(o.concept_id=165057, o.value_numeric,null)) as week_3_monthly_lubes_distributed,
                             max(if(o.concept_id=165056, o.value_numeric,null)) as week_3_monthly_female_condoms_distributed,
                             max(if(o.concept_id=165222, o.value_numeric,null)) as week_3_monthly_self_test_kits_distributed,
                             max(if(o.concept_id=1774, o.value_coded,null)) as week_3_received_clinical_service,
                             max(if(o.concept_id=1774, o.value_coded,null)) as week_3_violence_reported,
                             max(if(o.concept_id=1272, o.value_coded,null)) as week_3_referred,
                             max(if(o.concept_id=165147, o.value_coded,null)) as week_3_health_edu,

                              max(if(o.concept_id=165058,o.value_numeric, null)) as week_4_monthly_n_and_s_distributed,
                            max(if(o.concept_id=165055,o.value_numeric,null)) as week_4_monthly_male_condoms_distributed,
                            max(if(o.concept_id=165057, o.value_numeric,null)) as week_4_monthly_lubes_distributed,
                            max(if(o.concept_id=165056, o.value_numeric,null)) as week_4_monthly_female_condoms_distributed,
                            max(if(o.concept_id=165222, o.value_numeric,null)) as week_4_monthly_self_test_kits_distributed,
                            max(if(o.concept_id=1774, o.value_coded,null)) as week_4_received_clinical_service,
                            max(if(o.concept_id=1774, o.value_coded,null)) as week_4_violence_reported,
                            max(if(o.concept_id=1272, o.value_coded,null)) as week_4_referred,
                            max(if(o.concept_id=165147, o.value_coded,null)) as week_4_health_edu,
