...
CREATE PROCEDURE sp_populate_etl_client_registration(IN last_update_time DATETIME)
BEGIN
-- Update etl_client_registration table
...
CREATE PROCEDURE sp_populate_etl_client_social_status(IN last_update_time DATETIME)
BEGIN
...
ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),encounter_provider=VALUES(encounter_provider),key_population_type=VALUES(key_population_type),
hot_spot=VALUES(hot_spot),
weekly_sex_acts=VALUES(weekly_sex_acts),
weekly_anal_sex_acts=VALUES(weekly_anal_sex_acts),
daily_drug_injections=VALUES(daily_drug_injections),
avg_weekly_drug_injections=VALUES(avg_weekly_drug_injections),
voided=VALUES(voided);
END$$


DROP PROCEDURE IF EXISTS sp_populate_etl_client_enrollment$$
CREATE PROCEDURE sp_populate_etl_client_enrollment(IN last_update_time DATETIME)
BEGIN
...
contacted_for_prevention=VALUES(contacted_for_prevention),
contact_person_name=VALUES(contact_person_name),
regular_free_sexual_partner =VALUES(regular_free_sexual_partner ),
free_sexual_partner_name=VALUES(free_sexual_partner_name),
free_sexual_partner_alias=VALUES(free_sexual_partner_alias),
free_sexual_partner_contact=VALUES(free_sexual_partner_contact),
contact_regular_sexual_partner =VALUES(contact_regular_sexual_partner ),
sex_work_startdate =VALUES(sex_work_startdate ),
sex_with_men_startdate =VALUES(sex_with_men_startdate ),
drug_startdate =VALUES(drug_startdate ),
sexual_violence_experienced=VALUES(sexual_violence_experienced),
sexual_violence_ordeal=VALUES(sexual_violence_ordeal),
physical_violence_experienced=VALUES(physical_violence_experienced),
physical_violence_ordeal=VALUES(physical_violence_ordeal),
contact_clinical_appointment=VALUES(contact_clinical_appointment),
contact_method=VALUES(contact_method),
treatment_supporter_name=VALUES(treatment_supporter_name),
treatment_supporter_alias=VALUES(treatment_supporter_alias),
treatment_supporter_contact=VALUES(treatment_supporter_contact),
treatment_supporter_alt_contact=VALUES(treatment_supporter_alt_contact),
enrollment_notes=VALUES(enrollment_notes),
voided=VALUES(voided);
...
CREATE PROCEDURE sp_populate_etl_client_triage(IN last_update_time DATETIME)
	BEGIN
...
CREATE PROCEDURE sp_populate_etl_client_complaints(IN last_update_time DATETIME)
  BEGIN
...
;
    ...
    CREATE PROCEDURE sp_populate_etl_chronic_illness(IN last_update_time DATETIME)
      BEGIN
...
nature_of_illness,=VALUES(nature_of_illness),
onset_date,=VALUES(onset_date),
duration,=VALUES(duration),
remarks,=VALUES(remarks),
voided=VALUES(voided)
...
CREATE PROCEDURE sp_populate_etl_allergies(IN last_update_time DATETIME)
  BEGIN
...
;
    ...
    CREATE PROCEDURE sp_populate_etl_pregnancy_fp_cacx_screening(IN last_update_time DATETIME)
      BEGIN
...
elible_for_fp=VALUES(elible_for_fp),
fp_method=VALUES(fp_method),
referred_for_fp=VALUES(referred_for_fp),
cacx_screening=VALUES(cacx_screening),
cacx_screening_results=VALUES(cacx_screening_results),
...
END$$
    ...
    CREATE PROCEDURE sp_populate_etl_immunization_screening(IN last_update_time DATETIME)
      BEGIN
...
immunization_date=VALUES(immunization_date),
immunization_side_effects=VALUES(immunization_side_effects),
nature_of_side_effects=VALUES(nature_of_side_effects),
vaccine_validity=VALUES(vaccine_validity),
voided=VALUES(voided)
;
...
;
    ...
    CREATE PROCEDURE sp_populate_etl_hepatitis_screening(IN last_update_time DATETIME)
      BEGIN
...
END$$
    ...
    CREATE PROCEDURE sp_populate_etl_systems_review(IN last_update_time DATETIME)
      BEGIN
...
finding_notes=VALUES(finding_notes),
voided=VALUES(voided)
;
...
END$$
    ...
    CREATE PROCEDURE sp_populate_etl_diagnosis_treatment(IN last_update_time DATETIME)
      BEGIN
...
CREATE PROCEDURE sp_populate_etl_clinical_notes(IN last_update_time DATETIME)
  BEGIN
...
;
    ...
    CREATE PROCEDURE sp_populate_etl_appointment(IN last_update_time DATETIME)
      BEGIN
...
CREATE PROCEDURE sp_populate_etl_alcohol_drugs_risk_screening(IN last_update_time DATETIME)
  BEGIN
...
;
    ...
    CREATE PROCEDURE sp_populate_etl_violence_screening(IN last_update_time DATETIME)
      BEGIN
...
referral_ordered=VALUES(referral_ordered)
;
...
END$$
    ...
    CREATE PROCEDURE sp_populate_etl_prep_pep_screening(IN last_update_time DATETIME)
      BEGIN
...
or o.date_voided >= last_update_time
                          ...
                          group by e.encounter_id
                          ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),encounter_provider=VALUES(encounter_provider),test_type=VALUES(test_type),
...
months_since_last_test=VALUES(months_since_last_test),
patient_disabled=VALUES(patient_disabled),
disability_type=VALUES(disability_type),
patient_consented=VALUES(patient_consented),
client_tested_as=VALUES(client_tested_as),
test_strategy=VALUES(test_strategy),
hts_entry_point=VALUES(hts_entry_point),
test_1_kit_name=VALUES(test_1_kit_name),
test_1_kit_lot_no=VALUES(test_1_kit_lot_no),
test_1_kit_expiry=VALUES(test_1_kit_expiry),
test_1_result=VALUES(test_1_result),
test_2_kit_name=VALUES(test_2_kit_name),
test_2_kit_lot_no=VALUES(test_2_kit_lot_no),
test_2_kit_expiry=VALUES(test_2_kit_expiry),
test_2_result=VALUES(test_2_result),
...
patient_had_hiv_self_test =VALUES(patient_had_hiv_self_test ),
remarks=VALUES(remarks),
voided=VALUES(voided)
;
                          ...
                          CREATE PROCEDURE sp_populate_etl_hts_referral_and_linkage(IN last_update_time DATETIME)
                            BEGIN
...
provider_handed_to=VALUES(provider_handed_to),
provider_cadre=VALUES(provider_cadre),
remarks=VALUES(remarks),
voided=VALUES(voided)
;
END$$
                              ...
                              CREATE PROCEDURE sp_populate_etl_client_tracing(IN last_update_time DATETIME)
                                BEGIN
...
negative_outcome_reason=VALUES(negative_outcome_reason),
negative_outcome_description=VALUES(negative_outcome_description),
next_tracing_attempt_date=VALUES(next_tracing_attempt_date),
final_tracing_status=VALUES(final_tracing_status),
voided=VALUES(voided)
;
